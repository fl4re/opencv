...
# npm run custom version script and obtain the new patch version that appears in the updated package.json file
FL4RE_TAGGED_VERSION=$(npm -silent run version)

# npm publish the new version
npm publish

# all good, create a tag for this version
